  ...
  return (
    ...
    >
      ...
      <body className="bg-white text-black antialiased dark:bg-gray-950 dark:text-white">
        ...
        <a
          href="#main-content"
          className="focus:bg-primary-600 focus:ring-primary-600 dark:focus:bg-primary-500 dark:focus:ring-primary-500 sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:rounded-md focus:px-4 focus:py-2 focus:text-white focus:ring-2 focus:ring-offset-2 focus:outline-none"
        >
