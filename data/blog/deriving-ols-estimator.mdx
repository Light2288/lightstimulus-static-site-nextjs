---
title:
  en: Deriving the OLS Estimator
  it: Derivazione dello stimatore OLS

date: '2020-12-21'

summary:
  en: >
    How to derive the OLS estimator using matrix notation, with an overview of
    mathematical typesetting in Markdown using KaTeX.
  it: >
    Come derivare lo stimatore OLS utilizzando la notazione matriciale, con una
    panoramica sull’impaginazione matematica in Markdown tramite KaTeX.

tags:
  - id: next-js
    label: { en: Next.js, it: Next.js }
  - id: math
    label: { en: Math, it: Matematica }
  - id: ols
    label: { en: OLS, it: OLS }
