---
title:
  en: Images in Next.js
  it: Immagini in Next.js

date: '2020-11-11'

summary:
  en: >
    An introduction to adding images in the Tailwind Next.js starter blog, and an
    overview of the benefits and limitations of the next/image component.
  it: >
    Introduzione all’utilizzo delle immagini nel Tailwind Next.js starter blog,
    con una panoramica sui vantaggi e i limiti del componente next/image.
