---
title:
  en: Introducing Multi-part Posts with Nested Routing
  it: Introduzione ai post multi-parte con routing annidato
...
summary:
  en: >
    ...
    group posts of similar content, for example a multi-part course. This post
    itself is an example of a nested route.
  it: >
    Il template del blog supporta post in sottocartelle annidate. Questo permette
    di raggruppare contenuti simili, ad esempio un corso suddiviso in più parti.
    Questo post è esso stesso un esempio di routing annidato.

tags:
  - id: multi-author
    label: { en: Multi-Author, it: Multi-Autore }
  - id: next-js
    label: { en: Next.js, it: Next.js }
  - id: feature
    label: { en: Feature, it: Funzionalità }
