---
title:
  en: New features in v1
  it: Nuove funzionalità nella v1
...
summary:
  en: >
    An overview of the new features released in v1, including code block copy,
    multiple authors support, frontmatter layouts, and more.
  it: >
    Panoramica delle nuove funzionalità rilasciate nella v1, tra cui copia dei
    blocchi di codice, supporto a più autori, layout del frontmatter e altro.
