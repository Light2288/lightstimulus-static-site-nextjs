...
summary:
  en: >
    The scenic landscapes of Canada, featuring maple leaves, snow-capped
    mountains, turquoise lakes, and Toronto. A photo gallery showcasing how to
    recreate rich visual layouts with MDX and Tailwind.
  it: >
    I paesaggi suggestivi del Canada, tra foglie d’acero, montagne innevate,
    laghi turchesi e Toronto. Una galleria fotografica che mostra come creare
    layout visivi ricchi con MDX e Tailwind.

tags:
  - id: holiday
    label: { en: Holiday, it: Vacanza }
  - id: canada
    label: { en: Canada, it: Canada }
  - id: images
    label: { en: Images, it: Immagini }
