---
title:
  en: Release of Tailwind Next.js Starter Blog v2.0
  it: Rilascio di Tailwind Next.js Starter Blog v2.0

summary:
  en: >
    Release of Tailwind Next.js Starter Blog template v2.0, refactored with the
    Next.js App Router and React Server Components. Discover the new features and
    how to migrate from v1.
  it: >
    Rilascio del template Tailwind Next.js Starter Blog v2.0, rifattorizzato con
    App Router di Next.js e React Server Components. Scopri le nuove funzionalità
    e come migrare dalla v1.
