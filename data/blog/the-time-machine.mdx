...
summary:
  en: >
    The Time Traveller expounds a recondite matter, captivating his audience with
    animated expressions and vivid descriptions. An excerpt reflecting on time,
    narrative, and imagination.
  it: >
    Il Viaggiatore del Tempo espone un argomento recondito, catturando il pubblico
    con espressioni animate e descrizioni vivide. Un estratto che riflette su
    tempo, narrazione e immaginazione.

tags:
  - id: writings
    label: { en: Writings, it: Scritti }
  - id: book
    label: { en: Book, it: Libro }
  - id: reflection
    label: { en: Reflection, it: Riflessione }
