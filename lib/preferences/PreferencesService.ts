...
export const PreferencesService = {
   ...
   *
   * @param {('theme' | 'lang' | 'certGrouping')} key - The preference key to retrieve
   ...
   */
  getPref(key: 'theme' | 'lang' | 'certGrouping'): string | null {
   ...
   *
   * @param {('theme' | 'lang' | 'certGrouping')} key - The preference key to store
   ...
   */
  setPref(key: 'theme' | 'lang' | 'certGrouping', value: string): void {
